...
ComputerPlayer.prototype.getImage = function () {
  ...
  // What are the comments doing here?  They have nothing to do with getting images.
...
ComputerPlayer.prototype.think = function () {
  this.moveCount++;
  if (this.hit){ //nit: sometimes there's a space between the bracket and parenthesis, sometimes not.  Be consistent.  
    this.getBounced();
    this.hit = false;
    this.moveRandom();
...
ComputerPlayer.prototype.outsideSafeZone = function () {
  if ( // Just return, no need for the if.
