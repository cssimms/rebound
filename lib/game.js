...
Game.prototype.draw = function (ctx) {
    ...
    ctx.clearRect(0, 0, 600, 600); //Reuse DIM_X and DIM_Y
    ctx.drawImage(image, 0, 0, 600, 600); //Reuse DIM_X and DIM_Y
...
Game.prototype.checkCollisions = function () {
  ...
  this.discs.forEach(function (disc) {
    for (var i = 0; i < collisionProne.length; i++){ //Why not use forEach here?  You used it everywhere else?
